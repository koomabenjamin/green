...
import com.shapeworks.mivule.Adapters.MessagesAdapter;
...
public class InboxActivity extends AppCompatActivity implements
        MessagesAdapter.OnMessagesSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecycler = findViewById(R.id.inbox_recycler);
...
//                .whereEqualTo("email", email)
    ...
    private void initRecyclerView() {
        ...
        mAdapter = new MessagesAdapter(mQuery, this) {
...
//    }
    ...
    @Override
    public void onMessagesSelected(DocumentSnapshot restaurant) {
