...
import com.shapeworks.mivule.Adapters.ProductsAdapter;
...
public class ProductsActivity extends AppCompatActivity implements
        ProductsAdapter.OnProductsSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProjectRecycler = findViewById(R.id.product_recycler);
...
//                .whereEqualTo("email", email)
    ...
    private void initRecyclerView() {
        ...
        mAdapter = new ProductsAdapter(mQuery, this) {
...
//    }
    ...
    @Override
    public void onProductstSelected(DocumentSnapshot restaurant) {
